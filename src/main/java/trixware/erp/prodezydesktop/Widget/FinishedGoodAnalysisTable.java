...
public class FinishedGoodAnalysisTable extends javax.swing.JPanel {

    /**
     * Creates new form FinishedGoodAnalysisTable
     * Finished goods analysis report show in widget
     */
    private  ArrayList<String[]> rmList2 = new ArrayList<String[]> ();
     
    public FinishedGoodAnalysisTable() {
        initComponents();
        setSize(400, 200);
     ...
     private  void buildTableModelFGABC ( ArrayList<String[]> rs  )
             {
