 ...
 * @author dell
 */
public class ProductionValueChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "Production Value";

    double value=0;
    /**
     * Creates new form ProductionChart
     */
    public ProductionValueChart() {
        initComponents();
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String pvcaddEmpAPICall = "productionvalues?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String pvcresult2 = WebAPITester.prepareWebCall(pvcaddEmpAPICall, StaticValues.getHeader(), "");
             String pvcresult2 = new WebAPITester().executeWebCall(pvcaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (pvcresult2 != null) {
                pvcbuildTableModelfromJSON(pvcresult2, reportType, singleMonth.get(i)[1]);
            }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void pvcbuildTableModelfromJSON(String pvcemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(pvcemployeeJSONList);
        ...
        try {
           ...
           if ( reportMasterType.equals ( "Production Value" ) ) {
