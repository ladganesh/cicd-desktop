 ...
 * @author dell
 */
public class ProductionChart extends javax.swing.JPanel {
    ...
    public ProductionChart() {
        ...
        String reportMasterType = "Production Quantity";
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String prodaddEmpAPICall ="production?to_date="+ singleMonth.get ( i )[0]+"&from_date="+singleMonth.get ( i )[0]+"&freq=";
            //String prodaddEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String prodresult2 = WebAPITester.prepareWebCall(prodaddEmpAPICall, StaticValues.getHeader(), "");
             String prodresult2 =new WebAPITester().executeWebCall(prodaddEmpAPICall);
            //String prodresult2 = executeWebCall(prodaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (prodresult2 != null) {
                prodbuildTableModelfromJSON2(prodresult2, reportType, singleMonth.get(i)[1]);
            }
...
//        BarRenderer renderer = ( BarRenderer ) plot.getRenderer ();
        ...
        renderer.setSeriesItemLabelFont(0, new Font("Times New Roman", Font.PLAIN, 2));
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  String reportMasterType = "Production Quantity";

    private  void prodbuildTableModelfromJSON2(String prodemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(prodemployeeJSONList);
...
//                            } else
                    if (reportMasterType.equals("Productivity")) {
                        ...
                        if (columnIndex > 0) {
                            ...
                            if (columnIndex == 1) {
                                ab[columnIndex] = new String(df.format((Float.parseFloat(emp.get(columnNames.get(1)).toString()) / Float.parseFloat(emp.get(columnNames.get(3)).toString())) * 100));
                            }
...
//                }
                reportData.add(ab);
                //System.out.println("production data "+ab[0]);
                //System.out.println("production data "+ab[1]);
    ...
    private String executeWebCall (String resultofapi ) {
        
       String url = "http://"+StaticValues.getApiURL ()+"/projects/erp/public/"+resultofapi;
...
//         System.err.println(url);
        ...
        try {
            ...
            if( !resultofapi.contains ("auth/login" )){
