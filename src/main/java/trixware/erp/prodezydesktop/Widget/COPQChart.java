 ...
 * @author dell
 */
public class COPQChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "COPQ";
    ...
    public COPQChart() {
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String copqaddEmpAPICall = "pmphreport?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            
//            String copqresult2 = executeWebCall(copqaddEmpAPICall);
//            System.out.println("Copq result  "+copqresult2);
            String copqresult2 = new WebAPITester().executeWebCall(copqaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (copqresult2 != null) {
                copqbuildTableModelfromJSON(copqresult2, reportType, singleMonth.get(i)[1]);
            }
...
//        BarRenderer renderer = ( BarRenderer ) plot.getRenderer ();
        ...
        //renderer.setSeriesItemLabelFont(1, new Font("Times New Roman", Font.PLAIN, 5));
        ...
        axis1.setTickLabelFont(new Font("Dialog", Font.PLAIN, 0));
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void copqbuildTableModelfromJSON(String copqemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(copqemployeeJSONList);
        ...
        try {
           ...
           if ( reportMasterType.equals ( "COPQ" ) ) {
...
//                }
     ...
     private String executeWebCall (String classurl ) {

       String url = "http://"+StaticValues.getApiURL ()+"/projects/erp/public/"+classurl;
...
//         System.err.println(url);
        ...
        try {
            ...
            if( !classurl.contains ("auth/login" )){
