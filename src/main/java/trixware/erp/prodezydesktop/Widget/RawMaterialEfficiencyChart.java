 ...
 * @author dell
 */
public class RawMaterialEfficiencyChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "Raw Material Efficiency";

    double value=0;
    /**
     * Creates new form ProductionChart
     */
    public RawMaterialEfficiencyChart() {
        initComponents();
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String rmecaddEmpAPICall = "productrejection?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String rmecresult2 = WebAPITester.prepareWebCall(rmecaddEmpAPICall, StaticValues.getHeader(), "");
            String rmecresult2 = executeWebCall(rmecaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (rmecresult2 != null) {
                rmecbuildTableModelfromJSON(rmecresult2, reportType, singleMonth.get(i)[1]);
            }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void rmecbuildTableModelfromJSON(String rmecemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(rmecemployeeJSONList);
