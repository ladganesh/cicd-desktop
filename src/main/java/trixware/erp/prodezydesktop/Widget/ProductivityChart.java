 ...
 * @author dell
 */
public class ProductivityChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "Productivity";
    ...
    public ProductivityChart() {
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String pcaddEmpAPICall = "productionreport?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String pcresult2 = WebAPITester.prepareWebCall(pcaddEmpAPICall, StaticValues.getHeader(), "");
            String pcresult2 =new WebAPITester().executeWebCall(pcaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (pcresult2 != null) {
                pcbuildTableModelfromJSON(pcresult2, reportType, singleMonth.get(i)[1]);
            }

            firstChartParameter = reportType + " " + reportMasterType;
            secondChartParameter = reportType;
            thirdChartParameter = reportMasterType;
            chart = generatelineChartFromAPIData1(" ", reportType, reportMasterType, "");
        }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void pcbuildTableModelfromJSON(String pcemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(pcemployeeJSONList);
