 ...
 * @author dell
 */
public class RejectionChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "Rejection";

    double value=0;
    /**
     * Creates new form ProductionChart
     */
    public RejectionChart() {
        initComponents();
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String rejaddEmpAPICall = "productrejection?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String rejresult2 = WebAPITester.prepareWebCall(rejaddEmpAPICall, StaticValues.getHeader(), "");
            String rejresult2 =new WebAPITester().executeWebCall(rejaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (rejresult2 != null) {
                rejbuildTableModelfromJSON(rejresult2, reportType, singleMonth.get(i)[1]);
            }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void rejbuildTableModelfromJSON(String rejemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(rejemployeeJSONList);
