 ...
 * @author dell
 */
public class WorkInPrograssChart extends javax.swing.JPanel {
    ...
    private String reportMasterType = "Work In Progress";

    double value=0;
    /**
     * Creates new form ProductionChart
     */
    public WorkInPrograssChart() {
        initComponents();
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String wipaddEmpAPICall = "progressreport?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String wipresult2 = WebAPITester.prepareWebCall(wipaddEmpAPICall, StaticValues.getHeader(), "");
            String wipresult2 = new WebAPITester().executeWebCall(wipaddEmpAPICall);
            //System.out.println("" + addEmpAPICall);
            if (wipresult2 != null) {
                wipbuildTableModelfromJSON(wipresult2, reportType, singleMonth.get(i)[1]);
            }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void wipbuildTableModelfromJSON(String wipemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(wipemployeeJSONList);
