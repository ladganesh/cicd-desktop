 ...
 * @author dell
 */
public class OEEChart extends javax.swing.JPanel {
    ...
    public String secondChartParameter = "";
    public String thirdChartParameter = "";
    ...
    private String reportMasterType = "OEE";
    ...
    public OEEChart() {
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String oeeaddEmpAPICall = "oeereport_revised?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            String oeeresult2 =new WebAPITester().executeWebCall(oeeaddEmpAPICall);
            //String oeeresult2 = WebAPITester.prepareWebCall(oeeaddEmpAPICall, StaticValues.getHeader(), "");
            //System.out.println("" + addEmpAPICall);
            if (oeeresult2 != null) {
                oeebuildTableModelfromJSON(oeeresult2, reportType, singleMonth.get(i)[1]);
            }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private  void oeebuildTableModelfromJSON(String oeeemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(oeeemployeeJSONList);
        ...
        try {
           ...
           if ( reportMasterType.equals ( "OEE" ) ) {
