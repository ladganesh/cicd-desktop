 ...
 * @author Rajesh
 */
public class ButtonPanelBG  extends JPanel {

    private InnerPanel panel;

    public ButtonPanelBG() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        BufferedImage bi = new BufferedImage(width+2, 60, BufferedImage.TYPE_INT_ARGB);
        ...
        gb.setPaint(gp);
        gb.fillRect(0, 0, width+2, 60);
        gb.dispose();

        // Set a rounded clipping region:
        RoundRectangle2D r = new RoundRectangle2D.Float(0, 0, width+2, 60, 0, 0);
        g.setClip(r);
