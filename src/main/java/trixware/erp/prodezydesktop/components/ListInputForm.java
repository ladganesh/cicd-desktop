 ...
 * @author Rajesh
 */
public class ListInputForm extends javax.swing.JPanel {
    ...
    public ListInputForm () {
        initComponents ();
        jList1.addFocusListener ( valueListener );
        jLabel3.setVisible ( false );
    }

    public ListInputForm (String labelVal,  boolean isMandatory, String errorString) {
        initComponents ();
...
//        return jList1.getSelgetText ().trim () ;
//    }
