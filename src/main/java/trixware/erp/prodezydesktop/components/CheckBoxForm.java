 ...
 * @author Rajesh
 */
public class CheckBoxForm extends javax.swing.JPanel {
    ...
    public CheckBoxForm (String labelVal,  boolean isMandatory, String errorString, boolean _selectedOrNot, String value) {
        initComponents ();
    ...
    public CheckBoxForm (String labelVal,  boolean isMandatory, String errorString, ArrayList<String[]> cbListData) {
        initComponents ();
        mandatory = isMandatory ;
        jLabel2.setVisible ( mandatory );
        errorValue = errorString ;
