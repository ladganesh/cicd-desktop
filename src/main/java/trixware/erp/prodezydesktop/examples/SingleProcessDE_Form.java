 ...
 * @author Rajesh
 */
public class SingleProcessDE_Form extends javax.swing.JPanel {
...
//        jComboBox4.setBounds(1165, 0, 259, 30) ;
//        add( jComboBox4 ) ;
        revalidate ();
        repaint ();
    ...
    private void initComponents() {
        ...
        unitComboBoxOut = new javax.swing.JComboBox<>();
        unitComboBoxIn = new javax.swing.JComboBox<>();
        unitComboBoxOut1 = new javax.swing.JComboBox<>();
        ...
        add(jComboBox1);
        jComboBox1.setBounds(490, 10, 110, 30);
        ...
        add(jTextField1);
        jTextField1.setBounds(620, 10, 50, 30);
        ...
        add(jTextField2);
        jTextField2.setBounds(680, 10, 50, 30);
        ...
        add(jTextField3);
        jTextField3.setBounds(740, 10, 50, 30);
        ...
        add(jSpinner1);
        jSpinner1.setBounds(430, 10, 0, 30);

        jTextField6.setText("0");
        jTextField6.setPreferredSize(new java.awt.Dimension(0, 25));
        ...
        add(jTextField6);
        jTextField6.setBounds(120, 10, 0, 30);

        jTextField7.setText("0");
        jTextField7.setPreferredSize(new java.awt.Dimension(0, 25));
        add(jTextField7);
        jTextField7.setBounds(150, 10, 0, 30);
        ...
        jSpinner2.setPreferredSize(new java.awt.Dimension(0, 25));
        add(jSpinner2);
        jSpinner2.setBounds(180, 10, 0, 30);
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(41, 0));
        add(jLabel1);
        jLabel1.setBounds(480, 20, 0, 10);
        ...
        add(jComboBox3);
        jComboBox3.setBounds(800, 10, 0, 0);

        jButton1.setFont(new java.awt.Font("Leelawadee UI", 0, 10)); // NOI18N
        jButton1.setText("Select Shift");
        add(jButton1);
        jButton1.setBounds(1050, 10, 100, 23);

        jButton2.setFont(new java.awt.Font("Leelawadee UI", 0, 10)); // NOI18N
        jButton2.setText("AddTime Loss Details");
        add(jButton2);
        jButton2.setBounds(1160, 10, 140, 23);

        jButton3.setFont(new java.awt.Font("Leelawadee UI", 0, 10)); // NOI18N
        jButton3.setText("Rejections");
        add(jButton3);
        jButton3.setBounds(800, 10, 100, 23);

        unitComboBoxOut.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(unitComboBoxOut);
        unitComboBoxOut.setBounds(740, 40, 50, 20);

        unitComboBoxIn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        unitComboBoxIn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                unitComboBoxInActionPerformed(evt);
            }
        });
        add(unitComboBoxIn);
        unitComboBoxIn.setBounds(620, 40, 50, 20);

        unitComboBoxOut1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(unitComboBoxOut1);
        unitComboBoxOut1.setBounds(680, 40, 50, 20);
...
//change body of generated methods, choose Tools | Templates.
    ...
    private void unitComboBoxInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unitComboBoxInActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_unitComboBoxInActionPerformed
...
//    ArrayList<MachineDR> Machine;
    ...
    //    return sdf2.format ( dateChooserCombo3.getSelectedDate ().getTime () );
        return new SimpleDateFormat("MMM dd, yyyy" ).format ( dateChooserCombo3.getSelectedDate ().getTime () );
    }

    public String getFromTime () {
        //return fromHr+":"+fromMin;
        //return fromTimeSpinner.getValue ().toString () ;
        try {
            return new SimpleDateFormat ( "HH:mm" ).format ( ( Date ) new SimpleDateFormat ( "E MMM dd HH:mm:ss Z yyyy" ).parse ( fromTimeSpinner.getValue ().toString () ) );
        } catch ( ParseException e ) {
            return "";
    ...
    public String getToDate () {
        return new SimpleDateFormat("MMM dd, yyyy" ).format ( dateChooserCombo1.getSelectedDate ().getTime () );
    }
    ...
    public int getUomIn()
    {
        return unitComboBoxIn.getSelectedIndex();
    }
    public int getUomOut()
    {
        return unitComboBoxOut1.getSelectedIndex();
    }
    public int getUomOutRej()
    {
        return unitComboBoxOut.getSelectedIndex();
    }
    ...
    public void setEmployee_OLD ( ArrayList<EmployeeDR> employee ) {
        data.Employee = employee;
        //data.setEmployee ( ERROR );
    ...
    public void setUnit(ArrayList<UOMDR> oum) {
        data.UOM = oum;
//        unitComboBoxIn.removeAllItems();
//        unitComboBoxOut.removeAllItems();
//        unitComboBoxOut1.removeAllItems();
//        
//        for (int i = 0; i < oum.size(); i++) {
//            unitComboBoxIn.addItem(oum.get(i).UOM_NAME);
//            unitComboBoxOut.addItem(oum.get(i).UOM_NAME);
//            unitComboBoxOut1.addItem(oum.get(i).UOM_NAME);
//        }
    }
    public void setUnits(List<String> c)
    {
        ...
        for(String unit:c)
        {
            unitComboBoxOut1.addItem(unit);
            unitComboBoxOut.addItem(unit);
            unitComboBoxIn.addItem(unit);
        }
    ...
    {
        unitComboBoxIn.removeAllItems();
        unitComboBoxIn.addItem(uname);
    }
    public void setMachine_OLD ( ArrayList<MachineDR> machine ) {
   ...
   // public void setToTime ( int selShift ) {
   //     data.SelShift = selShift;
   // }
    ...
    private javax.swing.JComboBox<String> unitComboBoxIn;
    private javax.swing.JComboBox<String> unitComboBoxOut;
    private javax.swing.JComboBox<String> unitComboBoxOut1;
 ...
 * public void changedUpdate(DocumentEvent e) { changed(); } public void
 * removeUpdate(DocumentEvent e) { changed(); } public void
 * insertUpdate(DocumentEvent e) { changed(); }
 *
 * public void changed() { if (yourJTextField.getText().equals("")){
 * loginButton.setEnabled(false); } else { loginButton.setEnabled(true); }
 *
 * }
 * });
 */
