 ...
 * @author Rajesh
 */
public class DailyReportFormMachineWise extends javax.swing.JPanel {
...
//    HashMap<String, String> entity = null ;
    ...
    SingleProcessDE_FormMachineWise[] forms = null;
     ...
     */
    public DailyReportFormMachineWise () {
        initComponents ();
       ...
       Thread t = new Thread(){
        ...
        t.start();
       jComboBox1.addActionListener(batchList);
        //  System.out.println( "Total components in constructor "+getComponentCount () );
    }
    ActionListener batchList=new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            RMID=batches.get(jComboBox1.getSelectedIndex()).RMID;
        }
    };
    public DailyReportFormMachineWise(int a){}
    ...
    public void loadProcessesForProduct () {
        ...
        try {
            ...
            String queryFive = "SELECT  FG_ID, PART_NAME FROM finished_goods a INNER JOIN FG_PROCESS_MACH_MAP b on a.FG_ID = b.REF_FG_ID AND REF_PROCESS_ID = " + processes.get ( jComboBox2.getSelectedIndex () ).PRC_ID + "  AND REF_MCH_ID =" + machines.get ( jComboBox3.getSelectedIndex () ).MC_ID;
            // int selectedFG_ID =  products.get(jComboBox1.getSelectedIndex ()).FG_ID;
            result2 = DB_Operations.executeSingle ( queryFive );
            ...
            JOptionPane.showMessageDialog ( null , "Error1 process for product 1: " + e.getMessage () );
            ...
            JOptionPane.showMessageDialog ( null , "Error2 process for product 2: " + e.getMessage () );
            StaticValues.writer.writeExcel ( DailyReportFormMachineWise.class.getSimpleName () , DailyReportFormMachineWise.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
        }finally{
                 try {
                   result2.close();
...
/////////////////////////////////////////////           letest code for loading batches moved to loadProcessesForFinishedGoods method  ////////////////////////////////////////////////////////////
        ...
        forms = new SingleProcessDE_FormMachineWise[ processes.size () ];
        loadDE_Label ();
        loadDE_Form ();
    ...
    public void loadComboBoxes_OLD () {
        ...
        try {
            ...
            while ( result2.next () ) {
                ...
                machines.add ( mcdr );
                jComboBox3.addItem ( result2.getString ( 2 ) );
            }
    ...
    public void loadDE_Form () {
        ...
        String recordExists;
        SingleProcessDE_FormMachineWise abc = null;
        ...
        for ( int i = 0 ; i < processes.size () ; i ++ ) {
            ...
            abc = new SingleProcessDE_FormMachineWise ();
    ...
    public void loadDE_Label () {
        ...
        SingleProcessDE_LabelsMachine abc = new SingleProcessDE_LabelsMachine ();
    ...
    private void initComponents() {
        ...
        add(jButton1);
        jButton1.setBounds(1140, 377, 70, 30);
        ...
        add(jButton2);
        jButton2.setBounds(1220, 377, 70, 30);
        ...
        add(jComboBox2);
        jComboBox2.setBounds(453, 20, 0, 30);

        jLabel3.setFont(new java.awt.Font("Leelawadee UI", 0, 12)); // NOI18N
        jLabel3.setText("Select Machine");
        add(jLabel3);
        jLabel3.setBounds(310, 0, 90, 20);
        ...
        add(jComboBox3);
        jComboBox3.setBounds(310, 20, 130, 30);

        add(jComboBox1);
        jComboBox1.setBounds(170, 20, 130, 30);

        add(jComboBox4);
        jComboBox4.setBounds(30, 20, 130, 30);
...
//        loadingDialog.showLoadingDialog ( HomeScreen.home );
        ...
        SingleProcessDE_FormMachineWise abc1 = null;
        String abc = "";
        ...
        //                int uomin=dataList.get ( i ).getUomIn();
        //                int uomOut=dataList.get ( i ).getUomOut();
        //                int uomOutRej=dataList.get ( i ).getUomOutRej();
                        int rmid = batches.get ( jComboBox3.getSelectedIndex () ).RMID;
                        int fgid = products.get ( jComboBox1.getSelectedIndex () ).FG_ID;
                        if ( verifyFirstOrOnlyProcess ( products.get ( jComboBox1.getSelectedIndex () ).FG_ID , Integer.parseInt ( dataList.get ( i ).getProcessID () ) ) )
                        {
                            try{
...
HomeScreen.home.removeForms ();
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
      ...
      //  if ( products != null ) {
       //     forms = new SingleProcessDE_FormMachineWise[ products.size () ];
      //  }
