...
import static trixware.erp.prodezydesktop.examples.reports.DynamicDashboard_PMPH.abc;
 ...
 * @author Rajesh
 */
public class DynamicDashboard_PMPH extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public DynamicDashboard_PMPH ( String reportMasterType ) {
        initComponents ();
...
//        BarRenderer renderer = ( BarRenderer ) plot.getRenderer ();
    ...
    public double buildTableModelfromJSON_OEE ( String employeeJSONList , String reportType , String label ) {
        ...
        System.out.println ( "call from dynamic dashboard view result : " );
                        ...
                        JSONObject emp2 = records2.getJSONObject ( counter );
                            ...
                            try {
                                if ( columnIndex == 1 ) {
                                    ...
                                    if( gauge.getMaxValue () < oeeValue ){
                                        gauge.setMaxValue ( oeeValue );
                                    }
        ...
        public void run () {
            ...
            for ( int i = 0 ; i < abc.size () ; i ++ ) {
                try {
                    ...
                    StaticValues.writer.writeExcel (DynamicDashboard_PMPH.class.getSimpleName () , DynamicDashboard_PMPH.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
