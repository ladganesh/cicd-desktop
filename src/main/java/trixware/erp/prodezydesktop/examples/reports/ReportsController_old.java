 ...
 * @author Rajesh
 */
public class ReportsController_old extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public ReportsController_old ( String reportMasterType ) {
        initComponents ();
...
//                    _graph.start ();
//
//                    StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                }
//
//                //graphs[ i  ] = _graph ;
//            }
...
////                         try {       sleep ( 10*k );
////                    } catch ( InterruptedException IE1 ) {  StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , IE1.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , IE1.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );    }
////                      StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
////                    }
...
//               System.out.println("Error component "+e.getMessage ());
        ...
        for ( int i = 0 ; i < abc.size () ; i ++ ) {
            try {
                ...
                try {
                    ...
                    StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e2.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e2.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
                StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
            }
        }
        ...
        if ( reportMasterType.equals ( "Total Rejection" ) ) {
    ...
    public JFreeChart generateBarChartFromAPIData ( String reportTitle , String xAxis , String yAxis ) {
        ...
        renderer.setBaseItemLabelGenerator ( new StandardCategoryItemLabelGenerator () );
        renderer.setBarPainter ( new StandardBarPainter () );
        renderer.setSeriesPaint ( 1 , new Color(118,197,240 , 255) );
        renderer.setSeriesPaint ( 0 , new Color(88,147,180, 255) );
        renderer.setSeriesItemLabelFont ( 1 , new Font ( "Seoge" , Font.PLAIN , 8 ) );
        renderer.setSeriesItemLabelPaint ( 0 , Color.WHITE );
        renderer.setSeriesItemLabelFont ( 0 , new Font ( "Seoge" , Font.PLAIN , 8 ) );
    ...
    public void buildTableModelfromJSON ( String employeeJSONList , String reportType , String label ) {
        ...
        try {
            ...
            if ( reportMasterType.equals ( "Production Quantity" ) ) {
                columnNames.add ( "showrdate" );                        columnNames2.add ( "Date" );
                columnNames.add ( "outputqty" );                        columnNames2.add ( "Production" );
            } else if ( reportMasterType.equals ( "Production Value" ) ) {
                columnNames.add ( "showrdate" );                        columnNames2.add ( "Date" );
                columnNames.add ( "value" );                                columnNames2.add ( "Production Value" );
                columnNames.add ( "outputqty" );                            columnNames2.add ( "Production" );
                //columnNames.add ( "product" );                            columnNames2.add ( "Part Name" );
                columnNames.add ( "sales_rate" );                           columnNames2.add ( "Selling Price" );
            }else if (  reportMasterType.equals ( "Rejection" ) ) {
                columnNames.add ( "showrdate" );                            columnNames2.add ( "Date" );
                columnNames.add ( "rejection" );                                columnNames2.add ( "Rejected Qty" );
            }else if ( reportMasterType.equals ( "Productivity" ) ) {
                columnNames.add ( "showrdate" );            columnNames2.add ( "Date" );
                columnNames.add ( "outputqty" );            columnNames2.add ( "Efficiency" );
                columnNames.add ( "actual_hours" );         
                columnNames.add ( "exp_outputqty" );        
                columnNames.add ( "total_hours" );            

            }else if ( reportMasterType.equals ( "Total Rejection" ) ) {
                columnNames.add ( "showrdate" );            columnNames2.add ( "Date" );
                columnNames.add ( "ppm" );                      columnNames2.add ( "PPM" );
                columnNames.add ( "rejection" );            columnNames2.add ( "Rejected Qty" );
                columnNames.add ( "outputqty" );                columnNames2.add ( "Production" );
                columnNames.add ( "product" );                      columnNames2.add ( "Part Name" );
            }else if ( reportMasterType.equals ( "Work In Progress" ) ) {
                columnNames.add ( "MOVEDATE" );                 columnNames2.add ( "Date" );
                columnNames.add ( "balance" );                      columnNames2.add ( "Production Bal." );
                columnNames.add ( "process_name" );             columnNames2.add ( "Process" );
                columnNames.add ( "machine" );                      columnNames2.add ( "Machine" );
                columnNames.add ( "emp_no" );                       columnNames2.add ( "Employee" );
                columnNames.add ( "product" );                          columnNames2.add ( "Part Name" );
            }else if ( reportMasterType.equals ( "Defect Occurrances" ) ) {
                columnNames.add ( "RR_DESC" );                          columnNames2.add ( "Rejection Reason" );
                columnNames.add ( "occurences" );                     columnNames2.add ( "showrdate" );
                columnNames.add ( "count" );                                columnNames2.add ( "showrdate" );
                columnNames.add ( "rej_reason" );                      columnNames2.add ( "showrdate" );
                
            }else if ( reportMasterType.equals ( "Cost VS Value" ) ) {
                columnNames.add ( "showrdate" );                        columnNames2.add ( "Date" );
                columnNames.add ( "Cost" );                        columnNames2.add ( "Incurred Cost" );
                columnNames.add ( "Value" );                     columnNames2.add ( "Produced Value" );
            }else if ( reportMasterType.equals ( "PMPH" ) ) {
                columnNames.add ( "showrdate" );                        columnNames2.add ( "Date" );
                columnNames.add ( "PMPH" );                         columnNames2.add ( "PMPH" );
            }else if ( reportMasterType.equals ( "COPQ" ) ) {
                columnNames.add ( "showrdate" );                        columnNames2.add ( "Date" );
                columnNames.add ( "COPQ" );                        columnNames2.add ( "Cost of poor Quality" );
            }else if ( reportMasterType.equals ( "OEE" ) ) {
                columnNames.add ( "showrdate" );                            columnNames2.add ( "Date" );                        
                columnNames.add ( "actual_min" );                                      columnNames2.add ( "OEE" );                        
                columnNames.add ( "DAVLHRS" );                           columnNames2.add ( "Availability" );                     
                columnNames.add ( "outputqty" );                             columnNames2.add ( "Efficiency" );                        
                columnNames.add ( "actual_hours" );                                  columnNames2.add ( "Quality" );                          
...
//                            } else 
                    if ( reportMasterType.equals ( "Productivity" ) ) {
                        ...
                        if ( columnIndex == 0 ) {
                            ...
                            try {
                                    vector.add ( new String ( df.format ( ( Float.parseFloat ( emp.get ( columnNames.get ( 1 ) ).toString () ) / Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) )  *100 ) ) );
                                } catch ( NullPointerException | NumberFormatException e ) {
                                    vector.add ( "--" );
                                }
                        ...
                        if ( columnIndex == 0 ) {
                            ...
                            try {
                                ...
                                vector.add ( new String ( df.format ( ( ( Float.parseFloat ( emp.get ( columnNames.get ( 1 ) ).toString () ) / ( Float.parseFloat ( emp.get ( columnNames.get ( 2 ) ).toString () ) * 60 ) ) * ( ( Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) * Float.parseFloat ( emp.get ( columnNames.get ( 6 ) ).toString () ) ) / ( Float.parseFloat ( emp.get ( columnNames.get ( 4 ) ).toString () ) * 60 ) ) * ( ( Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) - Float.parseFloat ( emp.get ( columnNames.get ( 5 ) ).toString () ) ) / Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) ) ) * 100 ) ) );
                            } catch ( NullPointerException | NumberFormatException e ) {
                                vector.add ( "--" );
                            }
...
//                            } else
                    if ( reportMasterType.equals ( "Productivity" ) ) {
                        ...
                        try {
                            ...
                            if ( columnIndex == 1 ) {
                                ab[ 1 ] = df.format ( ( ( Float.parseFloat ( emp.get ( columnNames.get ( 1 ) ).toString () ) / ( Float.parseFloat ( emp.get ( columnNames.get ( 2 ) ).toString () ) * 60 ) ) * ( ( Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) * Float.parseFloat ( emp.get ( columnNames.get ( 6 ) ).toString () ) ) / ( Float.parseFloat ( emp.get ( columnNames.get ( 4 ) ).toString () ) * 60 ) ) * ( ( Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) - Float.parseFloat ( emp.get ( columnNames.get ( 5 ) ).toString () ) ) / Float.parseFloat ( emp.get ( columnNames.get ( 3 ) ).toString () ) ) ) * 100 );
                            } else {
                                ab[ 0 ] = emp.get ( columnNames.get ( 0 ) ).toString ();
                            }
                        } catch ( NullPointerException | NumberFormatException r ) {
...
//                reportData.add (  ab );
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(267, 20, 1010, 240);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(200, 10, 50, 14);
        ...
        jCheckBox6.setBounds(160, 450, 80, 25);
...
//                            cp.repaint ();
                            if( reportMasterType.equals ( "Defect Occurrances")  ){
                               ...
                               chart = generateBarChart2 ( "Cost VS Value" , "Cost" , "Value" );
                            }else if( reportMasterType.equals ( "Defect Occurrances")  ){
                                chart = generateBarChartFromAPIData ( reportType + " " + reportMasterType , reportType , reportMasterType );
                            }else {
                                chart = generateBarChartFromAPIData ( reportType + " " + reportMasterType , reportType , reportMasterType );
                            }
                ...
                for ( int i = 0, j = i + 1 ; j < weeklyDates.size () ; i = i + 2 , j += 2 ) {
                  ...
                  //  sb1.append ( "&freq=weekly" );
                    ...
                    toWeekDate = weeklyDates.get ( j ).split ( " " )[ 0 ].substring ( 5 );
                     ...
                     addEmpAPICall = sb1.toString ();
                     result2 = WebAPITester.prepareWebCall ( addEmpAPICall , StaticValues.getHeader () , "" );

                    System.out.println ( "" + addEmpAPICall );
                    if ( result2 != null ) {
//                        jTable1.setModel ( buildTableModelfromJSON ( result2 , reportType , "xAxisLabel" ) );
                 ...
                 if( reportMasterType.equals ( "Defect Occurrances")  ){
                   ...
                   chart = generateBarChart2 ( "Cost VS Value" , "Cost" , "Value" );
                    ...
                    chart = generateBarChartFromAPIData ( reportType + " " + reportMasterType  + " report for period " + weeklyDates.get ( 0 ).split ( " " )[ 0 ] + " to " + sdfTS.format ( c2.getTime () ) , reportType , reportMasterType );
                }
                ...
                for ( int i = 0, j = i + 1, k = 0 ; j < months.size () && k < 12 ; i = i + 2 , j += 2 , k ++ ) {
                 ...
                 if( reportMasterType.equals ( "Defect Occurrances")  ){
                   ...
                   chart = generateBarChart2 ( "Cost VS Value" , "Cost" , "Value" );
                    ...
                    chart = generateBarChartFromAPIData ( reportType + " " + reportMasterType  + " report for period " + months.get ( 0 ).split ( " " )[ 0 ] + " to " + months.get ( months.size () - 1 ).split ( " " )[ 0 ] , "MONTHS", reportMasterType );
                }
...
//                    StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e4.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e4.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                }
                ...
                try {
                 ...
                 if( reportMasterType.equals ( "Defect Occurrances")  ){
                   ...
                   chart = generateBarChart2 ( "Cost VS Value" , "Cost" , "Value" );
                    ...
                    chart = generateBarChartFromAPIData (  "Quarterly production report for year " + year + " - " + ( Integer.parseInt ( year ) + 1 )  , "Quarters" , reportMasterType );
                }
...
//                    StaticValues.writer.writeExcel ( ReportsController_old.class.getSimpleName () , ReportsController_old.class.getSimpleName () , e55.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e55.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                }
//
        ...
        for ( int i = 0 ; i < reportData.size () ; i ++ ) {
            try {
                ...
                try{
                    ...
                    System.out.println ( ""+e2 );
               //     StaticValues.writer.writeExcel ( ReportsController_old2.class.getSimpleName () , ReportsController_old2.class.getSimpleName () , e2.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e2.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
                System.out.println ( ""+e );
            //    System.out.println ( " "+ Float.parseFloat ( df.format ( Float.parseFloat ( abc.get ( i )[ 2 ] ) ) ) +  "    "+ abc.get ( i )[ 1 ]  );
            //StaticValues.writer.writeExcel ( ReportsController_old2.class.getSimpleName () , ReportsController_old2.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
            }
        }
    ...
    public void run () {
        ...
        try {
            for ( int k = 1 ; k <= 20 ; k ++ ) {
                ...
                ReportsController_V09.dataSet.addValue ( step * k , reportTitle , label );
            ...
            ReportsController_V09.dataSet.addValue ( total + rem , reportTitle , label );
            ...
            for ( int k = 1 ; k <= 20 ; k ++ ) {
                ...
                ReportsController_V09.dataSet.addValue ( step1 * k , reportTitle , label );
            ...
            ReportsController_V09.dataSet.addValue ( tota + rem1 , reportTitle , label );
