...
public class FGQualityReport_1 extends javax.swing.JPanel {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            if(param.size() != 0)
            {
                try {
                    ...
                    StaticValues.writer.writeExcel(FGQualityReport_1.class.getSimpleName(), FGQualityReport_1.class.getSimpleName(), e.getClass().toString(), Thread.currentThread().getStackTrace()[1].getLineNumber() + "", e1.getMessage(), StaticValues.sdf2.format(Calendar.getInstance().getTime()));
                }
            }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(dateChooserCombo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
       ...
       // addEmpAPICall = "partqty_data?batch_id=4&order_id=25&fg_id=1&param_id=3";
        ...
        if (result != null && !result.contains("not found")) 
        {
            ...
            for (int i = 0; i < records.length(); i++) 
            {
               ...
               String a= emp.getString("ref_prtqp_value");
