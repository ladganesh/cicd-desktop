 ...
 * @author Rajesh
 */
public class DynamicDashboard_PPM extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public DynamicDashboard_PPM ( String reportMasterType ) {
        initComponents ();
        ...
        public void run () {
            ...
            for ( int i = 0 ; i < abc.size () ; i ++ ) {
                try {
                    ...
                    StaticValues.writer.writeExcel (DynamicDashboard_PPM.class.getSimpleName () , DynamicDashboard_PPM.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
