 ...
 * @author Rajesh
 */
public class ReportsController_V09 extends javax.swing.JPanel {
...
//    }
    ...
    public ReportsController_V09 ( String reportMasterType ) {
        initComponents ();
...
//                         try {       sleep ( 10*k );
//                    } catch ( InterruptedException IE1 ) {  StaticValues.writer.writeExcel ( ReportsController_V09.class.getSimpleName () , ReportsController_V09.class.getSimpleName () , IE1.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , IE1.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );    }
//                      StaticValues.writer.writeExcel ( ReportsController_V09.class.getSimpleName () , ReportsController_V09.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                    }
                    ...
                    if ( reportMasterType.equals ( "Productivity" ) ) {
                        ...
                        if ( columnIndex > 0 ) {
                            ...
                            if(columnIndex==1)
                            {
                                ...
                                ab[ columnIndex ] = new String ( df.format ( (a / b) *100   )   ) ;
                            }
                            /*                            
                            ab[ columnIndex ] = "0";
...
//                    StaticValues.writer.writeExcel ( ReportsController_V09.class.getSimpleName () , ReportsController_V09.class.getSimpleName () , e4.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e4.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                }
...
//                    StaticValues.writer.writeExcel ( ReportsController_V09.class.getSimpleName () , ReportsController_V09.class.getSimpleName () , e55.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e55.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
//                }
//
