 ...
 * @author Rajesh
 */
public class DynamicDashboard_Productivity extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public DynamicDashboard_Productivity ( String reportMasterType ) {
        initComponents ();
                        ...
                        JSONObject emp2 = records2.getJSONObject ( counter );
                            ...
                            try {
                                if ( columnIndex == 1 ) {
                                    ...
                                    oeeValue = Double.parseDouble( emp2.get ( columnNames.get ( 1 ) ).toString () ) * 100  ;
        ...
        public void run () {
            ...
            for ( int i = 0 ; i < abc.size () ; i ++ ) {
                try {
                    ...
                    StaticValues.writer.writeExcel (DynamicDashboard_Productivity.class.getSimpleName () , DynamicDashboard_Productivity.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
