...
public class ProcessQualityReport_1 extends javax.swing.JPanel {
  ...
  //  public static DefaultCategoryDataset dataSet = null;
   // ArrayList<Double> value1 = new ArrayList<>();
    ...
    public ProcessQualityReport_1() {
        ...
        panel.setBounds(10, 120, 900, 500);
        //add.(panel);
        panel.revalidate();
        panel.repaint();
            ...
            if (order.size() != 0) 
            {
               ...
               if (param.size() != 0) {
                  ...
                  try {
                    ...
                    StaticValues.writer.writeExcel(ProcessQualityReport_1.class.getSimpleName(), ProcessQualityReport_1.class.getSimpleName(), e.getClass().toString(), Thread.currentThread().getStackTrace()[1].getLineNumber() + "", e1.getMessage(), StaticValues.sdf2.format(Calendar.getInstance().getTime()));
                }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jComboBox_FG, 0, 163, Short.MAX_VALUE)
                            .addComponent(jComboBox_process, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    public JFreeChart generateLineChart(String reportTitle, String xAxis, String yAxis, String chartType,int y) {
       ...
       // df.setMaximumFractionDigits(4);
        ...
        if (result != null && !result.contains("not found")) {
            ...
            for (int i = 0; i < records.length(); i++) {
                ...
                String a= emp.getString("ref_prcqp_value");
       ...
       DefaultCategoryDataset dataSet = new DefaultCategoryDataset();
        ...
        range.setRange(min - 0.1000, max + 0.1000);
