 ...
 * @author Rajesh
 */
public class DynamicDashboard_One extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public DynamicDashboard_One ( String reportMasterType ) {
        initComponents ();
...
//        add ( cp );
    ...
    public void createProductionChartPanel(){
        ...
        cp.setPreferredSize ( new java.awt.Dimension ( 390 , 290 ) );
        cp.setBounds ( 0 , 0 , 390 , 290 );
            ...
            case "Duration":
                ...
                Thread t2 = new Thread(){
                    ...
                    public void run(){
                                ...
                                chart = generateBarChartFromAPIData ( "" , reportType , reportMasterType,  chartType );
...
//        BarRenderer renderer = ( BarRenderer ) plot.getRenderer ();
     ...
     public void buildTableModelfromJSON ( String employeeJSONList , String reportType , String label ) {
        ...
        try {
            ...
            columnNames.add ( "fg_id" );                //columnNames.add ( "outputqty" );                  
            columnNames2.add ( "Part" );  
            columnNames.add ( "received" );                //columnNames.add ( "outputqty" );                  
            columnNames2.add ( "Production" );          //columnNames2.add ( "Production" );
            columnNames.add ( "date" );               //columnNames.add ( "showrdate" );               
       ...
       //     for ( int i = 0 ; i < reportData.size() ; i ++ ) {
        //        System.out.println ( " type  "+reportData.get(i)[0] + " value   "+reportData.get(i)[1] );
       //     }
...
/*    public void createOeeChartPanel(){
        ...
        oee_scroll.setBounds ( 440 , 10 , 430 , 300 );
            ...
            case "Duration":
                ...
                Thread t2 = new Thread(){
                    ...
                    public void run(){
                                ...
                                if ( result2 != null  ) {
                                        buildTableModelfromJSON_OEE (result2 , reportType ,  ""  ) ;
                                }
...
//                    StaticValues.writer.writeExcel (DynamicDashboard_One.class.getSimpleName () , DynamicDashboard_One.class.getSimpleName () , e2.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e2.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
                }
//                StaticValues.writer.writeExcel (DynamicDashboard_One.class.getSimpleName () , DynamicDashboard_One.class.getSimpleName () , e.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , e.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) );
            }
        }
...
//                dataSet , PlotOrientation.VERTICAL , true , true , false );
        ...
        cp = new ChartPanel ( chart );
        cp.setPreferredSize ( new java.awt.Dimension ( 400 , 330 ) );
        cp.setBounds ( 10 , 10 , 400 , 300 );
        cp.revalidate ();
        cp.repaint ();
...
/*    public void buildTableModelfromJSON_OEE ( String employeeJSONList , String reportType , String label ) {
        HashMap<String , Object> map = new HashMap<String , Object> ();
        JSONObject jObject = new JSONObject ( employeeJSONList );
        Iterator<?> keys = jObject.keys ();
                       ...
                       if ( columnIndex == 0 ) {
                           try{
                            if ( reportType.equalsIgnoreCase ( "Daily" ) ) {
                                    ...
                                    vector.add ( emp2.get ( columnNames.get ( columnIndex ) ) );
                            }
...
//                            System.err.println(df.format ( Float.parseFloat ( emp.get ( columnNames.get (2 ) ).toString () )));
                              vector.add ( new String (df.format ( Float.parseFloat ( emp2.get ( columnNames.get (1) ).toString () ))));
    ...
    private void initComponents() {
        ...
        add(chartChoice);
        chartChoice.setBounds(0, 0, 80, 15);
        ...
        switch ( reportType ) {
            ...
            case "Duration":
                ...
                } else if(reportMasterType.equals("Defect Occurrances"))
                {
                    ...
                    chart = generateBarChartFromAPIData("", secondChartParameter, thirdChartParameter, chartType);
                }
