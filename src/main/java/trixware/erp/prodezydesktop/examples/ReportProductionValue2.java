 ...
 * @author Rajesh
 */
public class ReportProductionValue2 extends javax.swing.JPanel {
...
//SimpleDateFormat sdf = null;
    ...
    public JFreeChart generateBarChart ( String reportTitle , String xAxis , String yAxis ) {
        ...
        for ( int i = 0 ; i < abc.size () ; i ++ ) {
            //try{
            dataSet.setValue ( Integer.parseInt ( abc.get ( i )[ 1 ] ) , "Production Value" , abc.get ( i )[ 0 ] );
...
//                                }
    ...
    public void loadEntries ( String reportType , int product ) {
        ...
        try {
            ...
            if ( reportType.equalsIgnoreCase ( "Yearly" ) ) {
                ...
                generateBarChart ( "Year to Date Production Value " , "YEAR" , "VALUE" );
    ...
    private void initComponents() {
        ...
        add(jLabel8);
        jLabel8.setBounds(40, 450, 80, 20);
        ...
        add(jLabel7);
        jLabel7.setBounds(40, 390, 70, 20);
        ...
        add(jLabel12);
        jLabel12.setBounds(40, 330, 70, 20);
        ...
        add(jCheckBox1);
        jCheckBox1.setBounds(210, 290, 73, 30);
        ...
        add(jCheckBox2);
        jCheckBox2.setBounds(210, 350, 73, 30);
        ...
        add(jCheckBox3);
        jCheckBox3.setBounds(210, 410, 73, 30);
        ...
        add(jCheckBox4);
        jCheckBox4.setBounds(210, 470, 73, 30);
...
//          
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (!jCheckBox1.isSelected () &&  !jCheckBox4.isSelected () && !jCheckBox2.isSelected () && !jCheckBox3.isSelected () ) {
        ...
        } else  if ( !jCheckBox4.isSelected () && !jCheckBox4.isSelected () && jCheckBox2.isSelected () && !jCheckBox3.isSelected () ) {
