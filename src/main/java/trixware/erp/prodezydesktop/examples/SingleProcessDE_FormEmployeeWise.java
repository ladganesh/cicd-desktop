 ...
 * @author Rajesh
 */
public class SingleProcessDE_FormEmployeeWise extends javax.swing.JPanel {

    DailyDataEntryModel data;
    
    public ArrayList<Rejection_Reasons> rej_reasons = null;
    public ArrayList<TimeLoss_Reasons> timeloss_reasons = null;
     ...
     */
    public SingleProcessDE_FormEmployeeWise () {
      ...
      // AutoCompletion.enable ( jComboBox3 );
        ...
        toTimeSpinner.setBounds ( 315 , 10 , 70 , 32 );
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(450, 10, 120, 30);
        ...
        add(jComboBox1);
        jComboBox1.setBounds(580, 10, 110, 22);
        ...
        add(jTextField1);
        jTextField1.setBounds(700, 10, 50, 30);
        ...
        add(jTextField2);
        jTextField2.setBounds(760, 10, 50, 30);
        ...
        add(jTextField3);
        jTextField3.setBounds(820, 10, 50, 30);
        ...
        dateChooserCombo3.setBounds(0, 10, 110, 30);
        ...
        dateChooserCombo1.setBounds(200, 10, 110, 30);

        jLabel1.setText("jLabel1");
        add(jLabel1);
        jLabel1.setBounds(570, 30, 30, 14);
...
//            throw new UnsupportedOperationException ( "Not supported yet." ); //To change body of generated methods, choose Tools | Templates.
        ...
        //    throw new UnsupportedOperationException ( "Not supported yet." ); //To change body of generated methods, choose Tools | Templates.
            ...
            try{    
                ...
                jcb.setText("0");
                StaticValues.writer.writeExcel ( SingleProcessDE_FormEmployeeWise.class.getSimpleName () , SingleProcessDE_FormEmployeeWise.class.getSimpleName () , ex1.getClass ().toString () , Thread.currentThread ().getStackTrace ()[ 1 ].getLineNumber () + "" , ex1.getMessage () , StaticValues.sdf2.format ( Calendar.getInstance ().getTime () ) ); 
            }
        }
    };
...
//change body of generated methods, choose Tools | Templates.
    ...
    private void UOMOUTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UOMOUTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_UOMOUTActionPerformed
...
//    public void setEmployee(ArrayList<Model.EmployeeDR> employee) {
...
//    public ArrayList<RMQtyPanel> rmBomList = null ;
    ...
    class ShowShiftSelection_old extends JDialog {
    ...
    class ShiftsList_old extends javax.swing.JPanel {
    ...
    class ShowTimeLossForm_old extends JDialog {
    ...
    class TimeLossList_old extends javax.swing.JPanel {
...
//    public ArrayList<RMQtyPanel> rmBomList = null ;
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class ShowRejectionsForm_old extends JDialog {

            private RejectionsList rejection;

            public ShowRejectionsForm_old ( Frame parent ) {
                super ( parent , "Login" , true );
    ...
    class RejectionsList_old extends javax.swing.JPanel {
    ...
    //    public ArrayList<RMQtyPanel> rmBomList = null ;
                public RejectionReasonList () {
                    ...
                    pane = new RejectionDetailPanel ();
                    pane.setRejectionReasonId ( 1);
                    pane.setRejectionReasonStr ( "RejectionReason 1");
                    pane.setRejectionForReason ( 0);
                    pane.setTotalRejection ( 5 );
                    panel.add ( pane );
                    panel.revalidate ();
                    rejectionList.add ( pane );

                    pane = new RejectionDetailPanel ();
                    pane.setRejectionReasonId ( 2);
                    pane.setRejectionReasonStr ( "RejectionReason 2");
                    pane.setRejectionForReason ( 0);
                    pane.setTotalRejection ( 5 );panel.add ( pane );
                    panel.revalidate ();
                    rejectionList.add ( pane );

                    pane = new RejectionDetailPanel ();
                    pane.setRejectionReasonId ( 3);
                    pane.setRejectionReasonStr ( "RejectionReason 3");
                    pane.setRejectionForReason ( 0);
                    pane.setTotalRejection ( 5 );panel.add ( pane );
                    panel.revalidate ();
                    rejectionList.add ( pane );
                    ...
                    pane = new RejectionDetailPanel ();
                     pane.setRejectionReasonId ( 4);
                    pane.setRejectionReasonStr ( "RejectionReason 4");
                    pane.setRejectionForReason ( 0);
                    pane.setTotalRejection ( 5 );panel.add ( pane );
                    panel.revalidate ();
